 ...
 */
public class AdaptationLogicSkeleton extends info.pppc.base.system.Skeleton  {
	
	/**
	 * Default constructor to create a new object.
	 */
	public AdaptationLogicSkeleton() { }
	...
	protected info.pppc.base.system.Result dispatch(String method, Object[] args) {
		de.mannheim.wifo2.fesas.sasStructure.adaptationLogic.IAdaptationLogic impl = (de.mannheim.wifo2.fesas.sasStructure.adaptationLogic.IAdaptationLogic)getImplementation();
		try {
