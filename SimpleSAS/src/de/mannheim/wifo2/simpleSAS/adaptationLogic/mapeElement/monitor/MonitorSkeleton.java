 ...
 */
public class MonitorSkeleton extends info.pppc.base.system.Skeleton  {
	...
	protected info.pppc.base.system.Result dispatch(String method, Object[] args) {
		de.mannheim.wifo2.fesas.sasStructure.adaptationLogic.mapeElement.monitor.IMonitor impl = (de.mannheim.wifo2.fesas.sasStructure.adaptationLogic.mapeElement.monitor.IMonitor)getImplementation();
		try {
