 ...
 */
public class AnalyzerSkeleton extends info.pppc.base.system.Skeleton  {
	
	/**
	 * Default constructor to create a new object.
	 */
	public AnalyzerSkeleton() { }
	...
	protected info.pppc.base.system.Result dispatch(String method, Object[] args) {
		de.mannheim.wifo2.fesas.sasStructure.adaptationLogic.mapeElement.analyzer.IAnalyzer impl = (de.mannheim.wifo2.fesas.sasStructure.adaptationLogic.mapeElement.analyzer.IAnalyzer)getImplementation();
		try {
