 ...
 */
public class ExecutorSkeleton extends info.pppc.base.system.Skeleton  {
	...
	protected info.pppc.base.system.Result dispatch(String method, Object[] args) {
		de.mannheim.wifo2.fesas.sasStructure.adaptationLogic.mapeElement.executor.IExecutor impl = (de.mannheim.wifo2.fesas.sasStructure.adaptationLogic.mapeElement.executor.IExecutor)getImplementation();
		try {
